  ...
  return (
    '<div style="background:#000000;padding:40px 20px;font-family:-apple-system,BlinkMacSystemFont,\'Helvetica Neue\',Helvetica,Arial,sans-serif;">' +
      '<div style="max-width:480px;margin:0 auto;">' +
        '<div style="text-align:center;color:#d4af37;font-size:13px;letter-spacing:0.12em;text-transform:uppercase;margin-bottom:36px;">Mandostan</div>' +
        ...
        '<div style="margin-top:40px;text-align:center;color:rgba(240,230,200,0.35);font-size:10px;letter-spacing:0.06em;">mandostan.net</div>' +
      '</div>' +
    '</div>'
  );
}
